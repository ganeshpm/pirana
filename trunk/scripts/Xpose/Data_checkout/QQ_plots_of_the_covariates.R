...
### Description: Creates cov.qq() using Xpose

models <- #PIRANA_IN
library(xpose4)

dir.create("pirana_temp")
pdf(paste("pirana_temp/","xpose_cov_qq_",names(models)[1],".pdf", sep=""))
...
print (paste("#", "PIRANA_OUT ","pirana_temp/xpose_cov_qq_",names(models)[1], ".pdf", sep=""))
