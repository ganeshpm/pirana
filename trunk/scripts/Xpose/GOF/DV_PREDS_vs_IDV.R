...
###
### Description: Creates dv.preds.vs.idv() using Xpose
###
...
pdf(paste("pirana_temp/","xpose_dv_ipred_idv_",names(models)[1],".pdf", sep=""))
...
print (paste("#", "PIRANA_OUT ","pirana_temp/xpose_dv_ipred_idv_",names(models)[1], ".pdf", sep=""))
