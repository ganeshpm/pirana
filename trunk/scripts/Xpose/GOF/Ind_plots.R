...
### Description: Creates ind.plots() using Xpose
...
pdf(paste("pirana_temp/xpose_ind_plots_",names(models)[1],".pdf", sep=""))
...
print (paste("#", "PIRANA_OUT ","pirana_temp/xpose_ind_plots_",names(models)[1], ".pdf", sep=""))
