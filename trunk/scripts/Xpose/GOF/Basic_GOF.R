...
### Description: Creates basic.gof() using Xpose
...
pdf(paste("pirana_temp/xpose_basic_gof_",names(models)[1],".pdf", sep=""))
...
print (paste("#", "PIRANA_OUT ","pirana_temp/xpose_basic_gof_",names(models)[1], ".pdf", sep=""))
