...
### Description: Creates ranpar.vs.cov() using Xpose

models <- #PIRANA_IN
library(xpose4)

dir.create("pirana_temp")
pdf(paste("pirana_temp/","xpose_eta_vs_cov_",names(models)[1],".pdf", sep=""))
...
print (paste("#", "PIRANA_OUT ","pirana_temp/xpose_eta_vs_cov_",names(models)[1], ".pdf", sep=""))
