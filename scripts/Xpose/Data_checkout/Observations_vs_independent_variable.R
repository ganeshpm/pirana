...
### Description: Creates dv.vs.idv() using Xpose

models <- #PIRANA_IN
library(xpose4)

dir.create("pirana_temp")
pdf(paste("pirana_temp/","xpose_dv_vs_idv_",names(models)[1],".pdf", sep=""))
...
print (paste("#", "PIRANA_OUT ","pirana_temp/xpose_dv_vs_idv_",names(models)[1], ".pdf", sep=""))
