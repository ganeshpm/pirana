...
### Description: Creates parm.qq() using Xpose

models <- #PIRANA_IN
library(xpose4)

dir.create("pirana_temp")
pdf(paste("pirana_temp/","xpose_dist_parm_qq_",names(models)[1],".pdf", sep=""))
...
print (paste("#", "PIRANA_OUT ","pirana_temp/xpose_dist_parm_qq_",names(models)[1], ".pdf", sep=""))
